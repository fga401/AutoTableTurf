...
class NxbtCommands(Enum):
    """An enumeration containing the nxbt1 message
    commands.
    """
...
class Nxbt():
    """The nxbt1 object implements the core multiprocessing logic
    ...
    def __init__(self, debug=False, log_to_file=False, disable_logging=False):
        ...
        # Shared dictionary for viewing overall nxbt1 state.
        # Should treated as read-only except by
        # the main nxbt1 multiprocessing process.
        ...
        # Starting the nxbt1 worker process
    ...
    def press_buttons(self, controller_index, buttons, down=0.1, up=0.1, block=True):
        ...
        :param controller_index: The index of a given controller
        :type controller_index: int
        :param buttons: A list of nxbt1.Buttons
        :type buttons: list
    ...
    def tilt_stick(self, controller_index, stick, x, y,
        ...
        :param controller_index: The index of a given controller
        :type controller_index: int
        :param stick: The right or left nxbt1.Stick
        :type stick: nxbt1.Stick
